...
Texture::Texture(Program *program, const int number, const string name, GLubyte *textureData, GLsizei textureSize){
    create(program, number, name);
    load(textureData, textureSize);
}
...
void Texture::load(GLubyte *textureData, GLsizei textureSize){
    LOG_PRINT_DEBUG("Load texture data");
